...
//     const topicSegment = () => 0.2;
//     const subtopicSegment = () => 0.2;
...
//         const firstHalf = Array.from({ length: Math.round(n / 2) }, (_, i) => i + 1);
...
//       const isSubtopic = 'subtopic' in (arc.data as any);
//       const isCategory = 'category' in (arc.data as any);
//       const isSubtopicHovered = Boolean(hoveredSubtopic?.id === (arc.data as any)?.id);
//     // text display
